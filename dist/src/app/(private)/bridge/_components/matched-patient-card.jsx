...
exports.MatchedPatients = MatchedPatients;
...
async function MatchedPatients() {
    const patientsAll = await server_1.api.patient.getMatched();
    const patients = patientsAll.slice(0, 5);
    return (<card_1.Card x-chunk="dashboard-01-chunk-5">
      <card_1.CardHeader className="flex flex-row items-center">
        <div className="grid gap-2">
          <card_1.CardTitle>Matched Patients</card_1.CardTitle>
        ...
        <button_1.Button asChild size="sm" className="ml-auto gap-1 bg-primary-purple-900">
          <link_1.default href="/bridge/match-list">
            Match List
            <lucide_react_1.ArrowUpRight className="h-4 w-4"/>
          </link_1.default>
        </button_1.Button>
      </card_1.CardHeader>
      <card_1.CardContent className="grid gap-8 px-6">
        <table_1.Table>
          <table_1.TableHeader>
            <table_1.TableRow>
