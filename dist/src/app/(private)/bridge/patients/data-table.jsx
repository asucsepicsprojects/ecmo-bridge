...
exports.PatientDataTable = PatientDataTable;
const React = __importStar(require("react"));
const react_table_1 = require("@tanstack/react-table");
const input_1 = require("~/components/ui/input");
const button_1 = require("~/components/ui/button");
const table_1 = require("~/components/ui/table");
const patient_form_1 = require("../_components/patient-form");
function PatientDataTable({ columns, data, }) {
    ...
    return (<div>
      <div className="flex items-center py-4">
        <input_1.Input placeholder="Filter names..." value={table.getColumn("name")?.getFilterValue() ?? ""} onChange={(event) => table.getColumn("name")?.setFilterValue(event.target.value)} className="max-w-sm"/>
      </div>
