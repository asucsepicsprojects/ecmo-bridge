...
function AboutComponent() {
    return (<section className="rounded-lg bg-white py-10 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 gap-x-10 gap-y-6 md:mt-20 md:grid-cols-2">
          ...
          <div>
            ...
            <link_1.default className="text-primary-purple-900 hover:text-primary-purple-400 hover:underline" href={"https://mail.google.com/mail/?view=cm&fs=1&to=amras@asu.edu"}>
              amras@asu.edu
            </link_1.default>
          </div>
        </div>
