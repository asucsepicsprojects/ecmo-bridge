...
const FAQ = () => {
    return (<section className="bg-transparent py-10 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-x-20 gap-y-16 md:mt-20 md:grid-cols-2">
          <div className="flex items-start">
            <react_icons_1.QuestionMarkCircledIcon className="text-primary-purple-600 h-8 w-8 flex-shrink-0"/>
            <div className="ml-4">
